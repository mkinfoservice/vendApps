        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceNumber = table.Column<string>(type: "character varying(60)", maxLength: 60, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductBarcodeSnapshot = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    Qty = table.Column<decimal>(type: "numeric(14,3)", nullable: false),
                    UnitCostCents = table.Column<int>(type: "integer", nullable: false),
                    TotalCents = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrders_CompanyId_Status_CreatedAtUtc",
